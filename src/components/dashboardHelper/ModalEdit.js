...
const ModalEdit = ({ openModalHook, data, color, text }) => {
    ...
    return (
        <div >
            ...
            <div className={`absolute z-30 top-72 md:right-1/3 md:left-1/3 left-10 right-10 bg-white flex flex-col p-3  transform scale-${ModalScale}  transition-transform ease-in rounded-xl`} style={{ transitionDuration: "200ms" }}>
